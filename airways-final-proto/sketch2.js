...
//             // Green route prioritizes parks & low pollution
//             if (isGreen && neighbour.park && pmVal<30) {
//                 moveCost = 0.1;
//             }
...
//     //green space & pm weighting

//             if (isGreen && pmVal>45) {
//                 moveCost = 0.6;
//             }

//             if (isGreen && pmVal>=36 && pmVal<=45) {
//                 moveCost = 0.2;
//             }

//             if (isGreen && pmVal>=0 && pmVal<=35) {
//                 moveCost = 0.2;
//             }
